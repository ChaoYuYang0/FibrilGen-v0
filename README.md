...
fibril.build_a_stacked_ribbon(10,30,90,3,20,1) # This is an example of calling the function build_a_stacked_ribbon with the initial geometrical parameters (tilt angle, radius, angle for rotational stacking, number of rotational stacking, number of units in the bilayer, and the direction of twist)
```
